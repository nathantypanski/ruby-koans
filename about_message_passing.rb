...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # ANSWER:
    # 
    # In case you define your own "#send" method!
  end
  ...
  def test_sending_a_message_with_arguments
    ...
    expect = [3, 4, nil, 6]
    assert_equal expect, mc.add_a_payload(3, 4, nil, 6)
    assert_equal expect, mc.send(:add_a_payload, 3, 4, nil, 6)
  end
  ...
  def test_foo_method_are_caught
    ...
    expected = "Foo to you too"
    assert_equal expected, catcher.foo_bar
    assert_equal expected, catcher.foo_baz
  end
